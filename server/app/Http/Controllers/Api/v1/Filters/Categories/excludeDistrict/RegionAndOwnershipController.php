...
class RegionAndOwnershipController extends Controller
{
    public function filterWithRegionAndOwnership($regionId, $ownership) {
        $gradeData = $this->storageByGrade($regionId, $ownership);
