...
class OwnershipIsNullController extends Controller
{
    public function filterWithoutOwnership($regionId, $registration, $crop, $grade) {
        $gradeData = $this->storageByGrade($regionId, $registration, $crop, $grade);
        $ownershipData = $this->storageByOwnership($regionId, $registration, $crop, $grade);
        $cropStoredAndCapacity = $this->storedCropAndCapacity($regionId, $registration, $crop, $grade);
        $warehouseCapacityAndCrops = $this->warehouseCapacityAndCrops($regionId, $registration, $crop, $grade);
        $utilization = $this->warehouseUtilization($regionId, $registration, $crop, $grade);
        $cropsLocation = $this->getCropsByLocation($regionId, $registration, $crop, $grade);
    ...
    public function storageByGrade($regionId, $registration, $crop, $grade) {
        $category = collect([]);
        $capacity = collect([]);
        $collection = collect([]);
        if($registration == 'yes') {
    ...
    public function storageByOwnership($regionId, $registration, $crop, $grade) {
        $category = collect([]);
        $capacity = collect([]);
        $collection = collect([]);
        if($registration == 'yes') {
    ...
    public function storedCropAndCapacity($regionId, $registration, $crop, $grade) {
        // return $ownership;
        $collection = collect([]);
        if($registration == 'yes') {
    ...
    public function warehouseCapacityAndCrops($regionId, $registration, $crop, $grade) {
    ...
    public function warehouseUtilization($regionId, $registration, $crop, $grade) {
        $collection = collect([]);
        // crops stored
        if($registration == 'yes') {
            $data = StockTaking::join('districts', 'districts.id', '=', 'stock_takings.district_id')
    ...
    public function getCropsByLocation($regionId, $registration, $crop, $grade) {
